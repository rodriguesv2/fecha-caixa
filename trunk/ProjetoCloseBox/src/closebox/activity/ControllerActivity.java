...
public class ControllerActivity extends Activity{
	...
	private void selecionaBotao(){
		...
		if(botao.equals("inicio")){ // chamada do botao "inicio",
			...
			intentOut.putExtra("acao", "lista"); // envia uma String "lista" com chave "botao"
			super.finish();
			startActivity(intentOut);
	 ...
	 * Recebe via Intent uma String com chave "botao" e de acordo com essa String chama outra Activity.
	 */
	private void selecionaAcao(){
		intentIn = getIntent();
		
		String botao = intentIn.getStringExtra("acao");
		
		if(botao.equals("calcularPontosDeVida")){//chamada quando abaixam-se todas as placas ou quando o Jogador pressiona "desistir"
			...
			if(pontosVida - pontosRestantes <1){//caso nao haja mais pontos restantes para o Jogador atual
				intentOut = new Intent(this, ScoreActivity.class);// faz a chamada da Activity ScoreActivity
				intentOut.putExtra("acao", "gravarPontuacao");//envia uma String "gravarPontuacao"
		...
		}else{//chamada em caso de falha / erro
